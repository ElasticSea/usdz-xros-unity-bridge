...
namespace pxr
{
	internal class UsdRiPINVOKE
	{
		...
		[DllImport("UsdCs", EntryPoint = "CSharp_pxr_UsdRiStatementsAPI_CreateRiAttribute__SWIG_1")]
		public static extern IntPtr UsdRiStatementsAPI_CreateRiAttribute__SWIG_1(HandleRef jarg1, HandleRef jarg2, string jarg3);

		[DllImport("UsdCs", EntryPoint = "CSharp_pxr_UsdRiStatementsAPI_CreateRiAttribute__SWIG_2")]
