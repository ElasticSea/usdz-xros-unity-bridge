...
namespace pxr
{
	internal class UsdCsPINVOKE
	{
		...
		protected class SWIGExceptionHelper
		{
			...
			[DllImport("UsdCs", EntryPoint = "SWIGRegisterExceptionArgumentCallbacks_UsdCs")]
			[MonoPInvokeCallback]
