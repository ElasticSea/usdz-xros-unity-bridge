...
namespace pxr
{
	public class UsdGeomTokens : IDisposable
	{
		...
		public static TfToken motionBlurScale = new TfToken("motion:blurScale");

		public static TfToken motionNonlinearSampleCount = new TfToken("motion:nonlinearSampleCount");
		...
		public UsdGeomTokens(IntPtr cPtr, bool cMemoryOwn)
		{
			swigCMemOwn = cMemoryOwn;
			swigCPtr = new HandleRef(this, cPtr);
		}

		public static HandleRef getCPtr(UsdGeomTokens obj)
		{
			return obj?.swigCPtr ?? new HandleRef(null, IntPtr.Zero);
		}

		public static HandleRef swigRelease(UsdGeomTokens obj)
		{
			if (obj != null)
			{
				if (!obj.swigCMemOwn)
