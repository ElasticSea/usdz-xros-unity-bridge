...
namespace pxr
{
	public class UsdLuxTokens : IDisposable
	{
		...
		public UsdLuxTokens(IntPtr cPtr, bool cMemoryOwn)
		{
			swigCMemOwn = cMemoryOwn;
			swigCPtr = new HandleRef(this, cPtr);
		}

		public static HandleRef getCPtr(UsdLuxTokens obj)
		{
			return obj?.swigCPtr ?? new HandleRef(null, IntPtr.Zero);
		}

		public static HandleRef swigRelease(UsdLuxTokens obj)
		{
			if (obj != null)
			{
				if (!obj.swigCMemOwn)
